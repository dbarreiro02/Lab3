...
public class ListaContactos {
    ...
    public void insertarNodoTemporal(PosicionPersona p) {
        ...
        while (aux != null && !salir) {
            if (aux.getFecha().compareTo(p.getFechaPosicion()) == 0) {
                 ...
                 */
                insertarEnListaCoordenadas(p, aux);
    ...
    private void insertarEnListaCoordenadas(PosicionPersona p, NodoTemporal aux) {
    ...
    public String toString() {
        ...
        for (cont = 1; cont < size; cont++) {
            cadenaBuilder.append(aux.getFecha().getFecha().toString());
            cadenaBuilder.append(";").append(aux.getFecha().getHora().toString()).append(" ");
            aux = aux.getSiguiente();
        }
